 ...
 * ## Installation
 *
 * `yarn add \@ericpereiraglobalsys/email-plugin`
 *
 * or
 *
 ...
 * for the email template files. If you used `\@ericpereiraglobalsys/create` to create your application, the templates will have
 ...
 * `node_modules/\@ericpereiraglobalsys/email-plugin/templates` to a location of your choice, and then point the `templatePath` config
 ...
 * } from '\@ericpereiraglobalsys/email-plugin';
 * import { CustomerService } from '\@ericpereiraglobalsys/core';
 *
