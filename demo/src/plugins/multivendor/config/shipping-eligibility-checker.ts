import { EntityHydrator, LanguageCode, ShippingEligibilityChecker, idsAreEqual } from '@ericpereiraglobalsys/core';
...
export const multivendorShippingEligibilityChecker = new ShippingEligibilityChecker({
  ...
  description: [
    ...
    { languageCode: LanguageCode.pt_BR, value: 'Verificador de elegibilidade de envio multivendedor' }
  ],
  args: {},
  init(injector) {
