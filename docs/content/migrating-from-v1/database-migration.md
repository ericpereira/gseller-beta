...
2. Use your package manager to install the [v2 migration tool](https://github.com/vendure-ecommerce/v2-migration-tool): `npm install @gseller/migrate-v2`
...
3. Add the `MigrationV2Plugin` to your plugins array:
   ```ts
   import { MigrationV2Plugin } from '@gseller/migrate-v2';
...
5. Edit the newly-created migration file by following the comments in these examples: 
   ...
   In your migrations files, you'll import the `vendureV2Migrations` from `@gseller/migrate-v2`.
